...
public class Priority {
    ...
    public Priority(String id, String code, String name, String description, String colorCode, Integer defaultDeadlineDays, boolean isActive) {
        this.id = id;
        this.code = code;
        this.name = name;
